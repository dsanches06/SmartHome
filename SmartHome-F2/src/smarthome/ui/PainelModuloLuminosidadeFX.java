 ...
 * @author
 */
public class PainelModuloLuminosidadeFX extends StackPane {

    private boolean botaoCor;

    public PainelModuloLuminosidadeFX(BorderPane root, GridPane grid, ConsolaCentral consola, Cliente cliente) {
